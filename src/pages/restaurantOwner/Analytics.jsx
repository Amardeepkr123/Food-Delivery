                  ...
                  <div key={status}>
                    <div className="flex justify-between text-sm mb-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-600 dark:text-gray-300 capitalize">{getStatusText(status)}</span>
                      </div>
          ...
          >
            ...
            <div className="space-y-4">
              {analyticsData.popularItems.map((item, index) => (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 flex items-center justify-center text-lg">
                    {index === 0 && '🥇'}
                    {index === 1 && '🥈'}
                    {index === 2 && '🥉'}
                    {index > 2 && `#${index + 1}`}
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 text-center">
                <p className="text-2xl font-bold text-green-500">{analyticsData.customerStats.newCustomers}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">New Customers</p>
              </div>
              <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 text-center">
                <p className="text-2xl font-bold text-blue-500">{analyticsData.customerStats.returningCustomers}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Returning Customers</p>
              </div>
            </div>

            <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Top Customers</h4>
            <div className="space-y-3">
