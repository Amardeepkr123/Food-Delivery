// src/pages/tracking/DeliveryStatus.jsx
...
import { FaUtensils, FaMotorcycle, FaLeaf, FaUtensils as FaUtensilsIcon } from 'react-icons/fa';
...
const statusFlow = [
  { key: 'placed', label: 'Order Placed', icon: FiPackage, time: '10:30 AM' },
  { key: 'accepted', label: 'Restaurant Accepted', icon: FiCheckCircle, time: '10:35 AM' },
  { key: 'preparing', label: 'Food Preparing', icon: FaUtensils, time: '10:45 AM' },
  { key: 'ready', label: 'Food Ready', icon: FiCheck, time: '11:00 AM' },
  { key: 'picked_up', label: 'Picked Up', icon: FiTruck, time: '11:10 AM' },
  { key: 'on_the_way', label: 'On the Way', icon: FiMapPin, time: '11:15 AM' },
  { key: 'nearby', label: 'Near Your Location', icon: FiTarget, time: '11:30 AM' },
  { key: 'delivered', label: 'Delivered', icon: FiCheckCircle, time: '11:45 AM' },
];
...
// Map Placeholder
const MapPlaceholder = ({ restaurant, customer, deliveryPartner, status }) => {
  return (
    <div className="relative w-full h-64 md:h-80 rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700">
      {/* Map Background */}
...
const DeliveryStatus = () => {
  ...
  useEffect(() => {
    ...
    const statuses = ['placed', 'accepted', 'preparing', 'ready', 'picked_up', 'on_the_way', 'nearby'];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
              <FaUtensilsIcon className="text-orange-500" />
              Order Details
            </h3>
              ...
              <div className="space-y-2">
                {order.items.map((item, index) => (
                  <div key={index} className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-800 dark:text-white">${item.price}</span>
                  </div>
                ))}
              </div>
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  {[20, 30, 50, 70, 100, 150].map((amount) => (
                    <button
                      key={amount}
